...
//                String k_picurl = imageUri.toString();
                ...
                if(TextUtils.isEmpty(Name)){
                    ...
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(admin_Doctor.this);
...
//                    builder1.setCancelable(true);
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    uploder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            Toast.makeText(admin_Doctor.this, "Data Inserted Successfully", Toast.LENGTH_SHORT).show();
                                        }
                                    });
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode ==1 && resultCode == RESULT_OK ){
            ...
            try {
                InputStream inputStream  = admin_Doctor.this.getContentResolver().openInputStream(imageUri);
